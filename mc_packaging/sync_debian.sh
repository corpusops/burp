...
export VER="3.1.4"
export FLAVORS="xenial bionic focal jammy noble"
export RELEASES="${RELEASES:-"experimental|stable|unstable|precise|trusty|utopic|vivid|oneric|wily|xenial|artful|bionic|disco|focal|jammy|impish|hirsute|groovy|noble"}"
